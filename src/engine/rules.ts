...
export function skillTestNh(character:Character,id:string,attribute:AttributeKey){const base=skillNh(character,id,attribute),load=encumbrance(character);return weightAffectedSkills.has(id.split(':')[0])&&load.penaltyValue!==null?base+load.penaltyValue:base}
