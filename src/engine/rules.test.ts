...
describe('skills and points',()=>{
  ...
  it('uses full Intelligence, not its Difference, in the published graduation cap',()=>{const c=make({age:34,attributes:{...defaultCharacter.attributes,inteligencia:10}});expect(maxSkillGraduation(c)).toBe(18)})
